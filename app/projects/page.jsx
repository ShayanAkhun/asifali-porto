...
import LongFormVideoCarousel from "@/components/Long Form Video carousel";
import ShortFormCarousel from "@/components/short-form-video-carousel";
			...
			<main className="overflow-hidden">
				...
				<div className="mt-10 flex flex-col justify-start items-center w-full pl-10 md:pl-32">
					<div className="flex justify-center items-center flex-col my-5 self-start ">
						...
						<h1 className="text-3xl font-bold mt-3">Long Form Videos</h1>
					</div>
				</div>
